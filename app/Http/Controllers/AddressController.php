...
class AddressController extends Controller
{
    ...
    // such as creating, updating, and deleting addresses.
    // You can implement methods like create, update, delete, etc.

    // private function to handle get contact by ID & by user ID
    ...
    public function create(int $idContact, AddressCreateRequest $request): JsonResponse
    {
        ...
        $address->contact_id = $contact->id; // Assuming the Address model has a contact_id field
        $address->save();
