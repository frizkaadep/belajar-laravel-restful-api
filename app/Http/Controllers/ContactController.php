...
class ContactController extends Controller
{
    ...
    {
        // Logic to handle contact creation
        // This method will typically return a view or redirect after processing the request
        $data = $request->validated();
        $user = Auth::user();

        $contact = new Contact($data);
        $contact->user_id = $user->id; // Assuming the Contact model has a user_id field
        $contact->save();
